...
(window.QUIZ_BATCHES = window.QUIZ_BATCHES || {})["genai-arch"] = [
  {
    ...
    ref: "LLM architecture — the transformer stack"
  },
  {
    ...
    ref: "LLM architecture — tokenization & BPE"
  },
  {
    ...
    ref: "LLM architecture — FFN expand-then-contract"
  },
  {
    ...
    ref: "LLM architecture — why attention is $O(n^2)$"
  },
  {
    ...
    ref: "LLM architecture — the KV cache"
  },
  {
    ...
    ref: "LLM architecture — FlashAttention"
  },
  {
    ...
    ref: "LLM architecture — normalization & positional schemes"
  },
  {
    ...
    ref: "LLM architecture — MHA vs MQA vs GQA"
  },
  {
    ...
    ref: "LLM architecture — Mixture-of-Experts"
  },
  {
    ...
    ref: "LLM architecture — scaling laws / Chinchilla"
  }
];
